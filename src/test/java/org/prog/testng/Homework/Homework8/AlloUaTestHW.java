package org.prog.testng.Homework.Homework8;
...
public class AlloUaTestHW {

    private final WebDriver driver = WebDriverFactory.getDriver();
    private AlloUaPageHW page;

    @BeforeSuite
    public void setUp() {
        page = new AlloUaPageHW(driver);
    }
    ...
    public void searchForPhone() {
        ...
        page.switchToSearchPageByNumber("3");
